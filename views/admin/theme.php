...
<div class="content-wrapper">
    ...
    if(isset($_POST['SaveSettings']))
    {
        ...
        if(check_img('logo_light') == true)
        {
            ...
            $uploads_dir = '../../assets/storage/images/logo_light.png';
            $tmp_name = $_FILES['logo_light']['tmp_name'];
            $addlogo = move_uploaded_file($tmp_name, $uploads_dir);
            if($addlogo)
            {
                $CMSNT->update('settings', [
                    'value'  => 'assets/storage/images/logo_light.png'
                ], " `name` = 'logo_light' ");
            }
        }
        ...
        {
            $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
            $uploads_dir = '../../assets/storage/images/logo_dark.png';
            $tmp_name = $_FILES['logo_dark']['tmp_name'];
            $addlogo = move_uploaded_file($tmp_name, $uploads_dir);
            if($addlogo)
            {
                $CMSNT->update('settings', [
                    'value'  => 'assets/storage/images/logo_dark.png'
                ], " `name` = 'logo_dark' ");
            }
        }
        ...
        {
            $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
            $uploads_dir = '../../assets/storage/images/favicon.png';
            $tmp_name = $_FILES['favicon']['tmp_name'];
            $addlogo = move_uploaded_file($tmp_name, $uploads_dir);
            if($addlogo)
            {
                $CMSNT->update('settings', [
                    'value'  => 'assets/storage/images/favicon.png'
                ], " `name` = 'favicon' ");
            }
        }
        ...
        {
            $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
            $uploads_dir = '../../assets/storage/images/image.png';
            $tmp_name = $_FILES['image']['tmp_name'];
            $addlogo = move_uploaded_file($tmp_name, $uploads_dir);
            if($addlogo)
            {
                $CMSNT->update('settings', [
                    'value'  => 'assets/storage/images/image.png'
                ], " `name` = 'image' ");
            }
        }
        ...
        {
            $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
            $uploads_dir = '../../assets/storage/images/bg_login.png';
            $tmp_name = $_FILES['bg_login']['tmp_name'];
            $addlogo = move_uploaded_file($tmp_name, $uploads_dir);
            if($addlogo)
            {
                $CMSNT->update('settings', [
                    'value'  => 'assets/storage/images/bg_login.png'
                ], " `name` = 'bg_login' ");
            }
        }
        ...
        {
            $rand = random('0123456789QWERTYUIOPASDGHJKLZXCVBNM', 3);
            $uploads_dir = '../../assets/storage/images/bg_register.png';
            $tmp_name = $_FILES['bg_register']['tmp_name'];
            $addlogo = move_uploaded_file($tmp_name, $uploads_dir);
            if($addlogo)
            {
                $CMSNT->update('settings', [
                    'value'  => 'assets/storage/images/bg_register.png'
                ], " `name` = 'bg_register' ");
            }
        }
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <img width="500px" src="<?=BASE_URL($CMSNT->site('logo_light'));?>"/><hr>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <img width="500px" src="<?=BASE_URL($CMSNT->site('image'));?>"/><hr>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <img width="500px" src="<?=BASE_URL($CMSNT->site('bg_login'));?>"/><hr>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <img width="500px" src="<?=BASE_URL($CMSNT->site('bg_register'));?>"/><hr>
                                    </div>
